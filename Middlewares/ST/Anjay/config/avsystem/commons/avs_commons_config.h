 ...
 *
 * NetX Duo: uses custom posix compat header with pointer-based sockfd_t
 * and poll() implementation backed by nx_udp_socket_receive().
 */
#define AVS_COMMONS_POSIX_COMPAT_HEADER "netxduo-posix-compat.h"
 ...
 *
 * DISABLED: We use our own NetXDuo implementation (avs_net_impl_netxduo.c)
 */
